                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="mt-2 space-y-1 text-sm text-gray-600">
                      ...
                      <p className={`inline-block px-2 py-1 rounded text-xs font-medium ${tax.status === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                        }`}>
                        {tax.status}
                      </p>
                    </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="mt-2 space-y-1 text-sm text-gray-600">
                      ...
                      <p className={`inline-block px-2 py-1 rounded text-xs font-medium ${pricing.status === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                        }`}>
                        {pricing.status}
                      </p>
                    </div>
